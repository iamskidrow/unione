...
export default {
    ...
    data() {
        return {
            profile: {},
            profile_options: [
                {text: 'Profile', url: '/student/profile'},
                {text: 'Settings', url: '/student/settings'},
            ...
            options: [
                ...
                {
                    text: 'Noticeboard',
                    url: '/student/noticeboard',
                    icon: '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-notification" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">\n' +
        ...
        <div class="container-xl">
            ...
            <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                <router-link to="/student/">
                    <img src="/src/assets/static/logo.png" alt="icon" class="navbar-brand-image">
                </router-link>
            </h1>
