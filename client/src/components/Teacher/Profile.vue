                    ...
                    <span class="avatar avatar-xs me-2 rounded"
                          :style="{ backgroundImage: `url(${profile.avatar_url})` }"></span>
                            ...
                            <div class="datagrid-item">
                                ...
                                <div class="datagrid-content">{{ profile.subjects }}
                                </div>
                            </div>
                            <div class="datagrid-item">
                                <div class="datagrid-title">Designation</div>
                                <div class="datagrid-content">{{ profile.designation }}
                                </div>
                            </div>
                            <div class="datagrid-item">
                                <div class="datagrid-title">Employee Number</div>
                                <div class="datagrid-content">{{ profile.employee_number }}</div>
                            </div>
                            <div class="datagrid-item">
                            ...
                            <div class="datagrid-item">
                                ...
                                <div class="datagrid-content">{{ formatDate(profile.joining_date) }}</div>
                            </div>
                        </div>
                    </div>
                </div>
